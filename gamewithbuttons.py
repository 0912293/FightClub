...
def menu():
    ...
    if ng:
        ...
        startB_img = pygame.transform.scale(pygame.image.load('b_start.png'), (screenX//4, 75))
        screen.blit(startB_img,(0, 150))

    if os.path.isfile("savefile"):
        load_button = Rect(0, 450, screenX//2.5, 75)
        loadB_img = pygame.transform.scale(pygame.image.load('b_load.png'), (screenX//5, 75))
        screen.blit(loadB_img,(0, 450))

    if ingame:
        save_button = Rect(0, 350, screenX//2.5, 75)
        saveB_img = pygame.transform.scale(pygame.image.load('b_save.png'), (screenX//4, 75))
    ...
    screen.blit(settingsB_img,(0,550))
    screen.blit(exitB_img, (0, 650))
...
def instructions():
    ...
    #draw text
    screen.blit(return_img, (screenX//2-(len("RETURN")*20), screenY-100))
